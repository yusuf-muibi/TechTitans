...
greater than 8 and must include  upper and lower case letters: """)
                if len(cus_pword) < 8 or not any(char.isupper() for char in cus_pword) or not any(char.islower() for char in cus_pword):
                    print("Password must contain character greater or equal to 8 and must include upper and lower case letters")
                    print("Pls try again")
                    continue
